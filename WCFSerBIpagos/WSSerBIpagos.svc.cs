...
using System.Web;
using System.Xml;
using WCFSerBIpagos.Models;
using WCFSerBIpagos.Services;

namespace WCFSerBIpagos
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de clase "WSSerBIpagos" en el código, en svc y en el archivo de configuración.
    // NOTE: para iniciar el Cliente de prueba WCF para probar este servicio, seleccione WSSerBIpagos.svc o WSSerBIpagos.svc.cs en el Explorador de soluciones e inicie la depuración.
    public class WSSerBIpagos : IWSSerBIpagos
    {
